;( function ( $ , window , document , undefined ) {
	...
	$.extend( Lightboxed.prototype , {
		...
		addToCache : function ( element ) {
			...
			if ( jQuery( element ).attr( 'data-type' ) == "photo" ) {
			...
			} else if (jQuery(element).attr('data-type') == "video") {
				var content = '<video controls> <source src="' + jQuery(element).attr('data-link') + '" type="video/mp4"> </video>';
